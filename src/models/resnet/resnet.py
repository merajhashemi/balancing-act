...
class ResNet(nn.Module):
    ...
    Args:
        norm_layer: Type of batch normalization to use. Can be `nn.BatchNorm2d` or
            ...
            layer must be an instance of `MaskedConv2d` layer.
        ...
        masked_layer_kwargs: Keyword arguments to pass to the construction of
            the masked layers prescribed in `masked_conv_ix`.
    """
    ...
    def __init__(
        ...
        # We do NOT use bias in ResNets (like Pytorch implementation)
        ...
        self.fc = last_fc_layer(in_features=512 * block.expansion, out_features=num_classes, bias=True)
...
def ResNet18(num_classes: int = 200, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-18 model."""

    return ResNet(block=BasicBlock, layers=[2, 2, 2, 2], num_classes=num_classes, **kwargs)


def ResNet50(num_classes: int = 1000, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-50 model."""

    return ResNet(block=Bottleneck, layers=[3, 4, 6, 3], num_classes=num_classes, **kwargs)


def ResNet34(num_classes: int = 1000, **kwargs: Any) -> ResNet:
    """Constructs a ResNet-34 model."""

    return ResNet(block=BasicBlock, layers=[3, 4, 6, 3], num_classes=num_classes, **kwargs)
